...
urlpatterns = patterns('game.views',
    url(r'^$', 'index'),
    url(r'^profile/$', 'get_user_profile_fw'),
    url(r'^profile/(?P<username>[0-9A-Za-z]+)/$', 'get_user_profile'),
    url(r'^score/$', 'get_game_score_list_fw'),
    url(r'^score/(?P<username>[0-9A-Za-z]+)/$', 'get_game_score_list'),
